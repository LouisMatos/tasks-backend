pipeline{
    ...
    post{
           ...
           unsuccessful {
               emailext attachLog: true, body: 'See the attached log bellow', subject: 'Build $BUILD_NUMBER has faild', to: 'luis.felipe.pereira.matos+jenkins@gmail.com'
           }
           fixed {
               emailext attachLog: true, body: 'See the attached log bellow', subject: 'Build $BUILD_NUMBER is fine', to: 'luis.felipe.pereira.matos+jenkins@gmail.com'
           }
       }
}